...
/**
 * Cursor 조회 결과를 application 계층 안에서 전달하기 위한 객체다.
 * API 응답 객체와 분리해 Repository가 presentation 계층에 의존하지 않도록 한다.
 */
public record ProductCursorResult<T>(
    ...
    /** 다음 페이지가 없으므로 Cursor 정보를 비워 반환한다. */
